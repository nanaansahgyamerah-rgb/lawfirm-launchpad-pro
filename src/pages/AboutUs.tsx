    ...
    <div className="min-h-screen">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              <img 
                src={officeInterior} 
                alt="Our Law Office" 
                className="w-full h-96 lg:h-[500px] object-cover rounded-lg shadow-professional"
              />
              <div className="absolute -bottom-6 -right-6 bg-background rounded-lg shadow-elegant p-6 border">
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          ...
          {/* Core Values */}
          <div className="space-y-8">
            <h3 className="text-3xl font-bold text-center text-foreground">Our Core Values</h3>
